...
// Updated navigation items for the sidebar with corrected user routes
export const updatedNavigation: NavItem[] = [
  {
    translationKey: "common.navigation.dashboard",
    href: (role: string, locale: string) => {
      if (role === "ADMIN") return `/${locale}/dashboard/admin`;
      if (role === "INSTITUTION") return `/${locale}/dashboard/institution`;
  ...
  },
  {
    ...
    href: (role: string, locale: string) => {
      if (role === "ADMIN") return `/${locale}/dashboard/admin/analytics`;
      return `/${locale}/dashboard/institution/analytics`;
    },
    icon: ChartBarIcon,
    current: false,
  ...
  },
  {
    ...
    href: (role: string, locale: string) => {
      ...
      return `/${locale}/dashboard/users/certificates`; // Regular users see certificates on their dedicated page
    },
  ...
  },
  {
    ...
    href: (role: string, locale: string) => {
      ...
      if (role === "INSTITUTION") return `/${locale}/dashboard/institution/support`;
      return `/${locale}/dashboard/users/support`; // User-specific support page
    },
